...
{
    internal record FakeInstrumentSpecification
    {
        ...
        internal FakeInstrumentSpecification()
        {
        }
        internal FakeInstrumentSpecification(string[] instrumentTunes, string[] instrumentTypes, string[] instrumentBrands, string[] instrumentModels)
        {
